...
namespace LinkedListTraining_tests
{
    ...
    public class Sort_tests
    {
        ...
        [TestMethod]
        public void Selection_TwoItems_ReturnSorted()
        {
            var arr = new int[] { 2, 1 };
            var desired = new int[] { 1, 2 };
        ...
        [TestMethod]
        public void Selection_EvenItems_ReturnSorted()
        {
            var arr = new int[] { 2, 1, 4, 8, 9, 6 };
            var desired = new int[] { 1, 2, 4, 6, 8, 9 };
        ...
        [TestMethod]
        public void Insertion_EvenItems_ReturnSorted()
        {
            var arr = new int[] { 2, 1, 4, 8, 9, 6 };
            var desired = new int[] { 1, 2, 4, 6, 8, 9 };
        ...
        [TestMethod]
        public void Insertion_TwoItems_ReturnSorted()
        {
            var arr = new int[] { 2, 1 };
            var desired = new int[] { 1, 2 };
